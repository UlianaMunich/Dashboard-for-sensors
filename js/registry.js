...
function registry_parsing(sensor_json) {
    ...
    for (var i = 0; i < json.sensor_list.length; i++) {
        if (json.sensor_list[i].availability == true) {
            ...
            var tag_favorites = "<div class='favorites col-md-2'><button id='favorites' type='button' class='btn btn-default'><img class='img-responsive' src='img/star.png'/><span class='glyphicon glyphicon-star-empty'></span></button></div>";
